...
#end
#end
public class #(entityClassName)EditVo#if(withActiveRecord) extends Model<#(entityClassName)>#else#(table.buildExtends())#(table.buildImplements())#end  {
