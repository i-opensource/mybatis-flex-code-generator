...
#end
#end
public class #(entityClassName)ListVo#if(withActiveRecord) extends Model<#(entityClassName)>#else#(table.buildExtends())#(table.buildImplements())#end  {
