 ...
 * @since 2024
 */
public class ListVoGenerator implements IGenerator {

    private String templatePath = "templates/enjoy/entityListVo.tpl";
    ...
    public void generate(final Table table, final GlobalConfig globalConfig) {
        ...
        File entityJavaFile = new File(packageConfig.getSourceDir(), editVoPackage.concat("/").concat(table.buildEntityClassName()).concat("ListVo.java"));
