 ...
 * @since 2024
 */
public class EditVoGenerator implements IGenerator {

    private String templatePath = "templates/enjoy/entityEditVo.tpl";
    ...
    public void generate(final Table table, final GlobalConfig globalConfig) {
        ...
        File entityJavaFile = new File(packageConfig.getSourceDir(), editVoPackage.concat("/").concat(table.buildEntityClassName()).concat("EditVo.java"));
